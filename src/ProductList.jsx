...
function ProductList({ onHomeClick }) {
  ...
  const plantsArray = [
    ...
    },
    {
      ...
      plants: [
        { name: "Lavender", image: "https://images.unsplash.com/photo-1611909023032-2d6b3134ecba?q=80", description: "Calming scent, used in aromatherapy.", cost: "20" },
        { name: "Jasmine", image: "https://images.unsplash.com/photo-1592729645009-b96d1e63d14b?q=80", description: "Sweet fragrance, promotes relaxation.", cost: "18" },
    ...
    },
    {
      ...
      plants: [
        { name: "ZZ Plant", image: "https://images.unsplash.com/photo-1632207691143-643e2a9a9361?q=80", description: "Thrives in low light and requires minimal watering.", cost: "25" },
        ...
        { name: "Succulents", image: "https://cdn.pixabay.com/photo/2016/11/21/16/05/cacti-1846147_1280.jpg", description: "Drought-tolerant with unique shapes and colors.", cost: "18" },
        { name: "Aglaonema", image: "https://cdn.pixabay.com/photo/2014/10/10/04/27/aglaonema-482915_1280.jpg", description: "Requires minimal care and adds color indoors.", cost: "22" }
      ]
    }
  ];
    ...
    <div>
      ...
      <div className="navbar" style={styleObj}>
        <div className="luxury">
          <img src="https://cdn.pixabay.com/photo/2020/08/05/13/12/eco-5465432_1280.png" alt="" height="50" />
